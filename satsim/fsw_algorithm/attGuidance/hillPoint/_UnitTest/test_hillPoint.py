...
from satsim.fsw_algorithm.attGuidance.hillPoint import (
    HillPoint,
)
...
def test_HillPoint(celMsgSet):
    r"""

    """
    state_dict, (sigma_RN, omega_RN_N, dot_omega_RN_N) = HillPointTestFunction(celMsgSet)
...
def HillPointTestFunction(celMsgSet):
    """Test method"""
    module = HillPoint()
